            ...
            <div className="flex items-start gap-8">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  ...
                  <span>{user.dailyRatingsLeft} ratings remaining today</span>
                </div>
              </div>
            </div>
          </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          <h3 className="font-semibold text-gray-900 mb-1 group-hover:text-txst-maroon transition-colors">
                            {rating.professorName}
                          </h3>
                          <div className="text-sm text-gray-500">{rating.courseId}</div>
                        </div>
                      </div>
                      <div className="text-xs text-gray-400">
                        {rating.timestamp.toLocaleDateString('en-US', {
                          year: 'numeric',
                          month: 'long',
                          day: 'numeric',
                          hour: '2-digit',
